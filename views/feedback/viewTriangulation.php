                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="../controllers/feedback/feedbackController.php" method="POST">
                                                ...
                                                <input type="hidden" name="tb_remonteId" value="<?= $remonteSelected ?>">
                                                <input type="hidden" name="tb_projectId" value="<?= $projectSelected ?>">
                                                <input type="hidden" name="tb_soumissionId" value="<?= $_GET['use_soumission'] ?>">
                                                <input type="hidden" name="tb_triangulationId" value="<?= $triangulation['trId'] ?>">
                                                <button class="btn btn-primary" name="bt_for_view_triangulation_details" type="submit"><i class="fa fa-file" aria-hidden="true"></i> View details</button>
