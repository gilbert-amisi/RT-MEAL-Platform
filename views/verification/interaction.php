<script>
    ...
    function zoomToFeature(e) {
        ...
        location.href = "home.php?render=<?= sha1("tpmtable") ?>&sub=<?= sha1("start") ?>&phaseId=<?= $getPhase ?>"+"&territory="+actualTerr;
    ...
    info.update = function(props) {
        this._div.innerHTML = '<h6>Territory</h6>' + (props ?
            '<h4><b>' + props.name + '</b></h4><hr />' + 
            '<h6><i class="fa fa-circle" style="color: red; width: 12px;"></i> ' + <?= $nbred ?> + ' activitie(s) in danger</h6><br>' +
            '<h6><i class="fa fa-circle" style="color: orange; width: 12px;"></i> ' + <?= $nborange ?> + ' activitie(s) in medium</h6><br>' +
            '<h6><i class="fa fa-circle" style="color: green; width: 12px;"></i> ' + <?= $nbgreen ?> + ' activitie(s) successful</h6><br>' :
